...
static const ::std::string __mapreduce__slice__MonitorService__getCurrentRunningTasks_name = "getCurrentRunningTasks";
...
::mapreduce::slice::TasksDetail
IceProxy::mapreduce::slice::MonitorService::getCurrentRunningTasks(const ::Ice::Context& __ctx)
{
    int __cnt = 0;
    while(true)
    {
	try
	{
	    __checkTwowayOnly(__mapreduce__slice__MonitorService__getCurrentRunningTasks_name);
	    ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase = __getDelegate();
	    ::IceDelegate::mapreduce::slice::MonitorService* __del = dynamic_cast< ::IceDelegate::mapreduce::slice::MonitorService*>(__delBase.get());
	    return __del->getCurrentRunningTasks(__ctx);
	}
	catch(const ::IceInternal::LocalExceptionWrapper& __ex)
	{
	    __handleExceptionWrapper(__ex);
...
::mapreduce::slice::TasksDetail
IceDelegateM::mapreduce::slice::MonitorService::getCurrentRunningTasks(const ::Ice::Context& __context)
{
    ::IceInternal::Outgoing __og(__connection.get(), __reference.get(), __mapreduce__slice__MonitorService__getCurrentRunningTasks_name, ::Ice::Normal, __context, __compress);
    bool __ok = __og.invoke();
    try
    {
	::IceInternal::BasicStream* __is = __og.is();
...
::mapreduce::slice::TasksDetail
IceDelegateD::mapreduce::slice::MonitorService::getCurrentRunningTasks(const ::Ice::Context& __context)
{
    ::Ice::Current __current;
    __initCurrent(__current, __mapreduce__slice__MonitorService__getCurrentRunningTasks_name, ::Ice::Normal, __context);
    while(true)
    {
	::IceInternal::Direct __direct(__current);
	::mapreduce::slice::MonitorService* __servant = dynamic_cast< ::mapreduce::slice::MonitorService*>(__direct.servant().get());
	...
	try
	{
	    return __servant->getCurrentRunningTasks(__current);
	}
	catch(const ::Ice::LocalException& __ex)
	{
	    throw ::IceInternal::LocalExceptionWrapper(__ex, false);
...
::IceInternal::DispatchStatus
mapreduce::slice::MonitorService::___getCurrentRunningTasks(::IceInternal::Incoming&__inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Normal, __current.mode);
    ::IceInternal::BasicStream* __os = __inS.os();
    ::mapreduce::slice::TasksDetail __ret = getCurrentRunningTasks(__current);
    if(__ret.size() == 0)
    {
	__os->writeSize(0);
    }
...
{
    ::std::pair< ::std::string*, ::std::string*> r = ::std::equal_range(__mapreduce__slice__MonitorService_all, __mapreduce__slice__MonitorService_all + 12, current.operation);
    if(r.first == r.second)
    {
	...
	case 2:
	{
	    return ___getCurrentRunningTasks(in, current);
	}
	case 3:
	{
