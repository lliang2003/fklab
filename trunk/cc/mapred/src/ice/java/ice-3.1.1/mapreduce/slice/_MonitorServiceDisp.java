...
public abstract class _MonitorServiceDisp extends Ice.ObjectImpl implements MonitorService
{
    ...
    {
	return getCurrentRunningTasks(null);
    }
    ...
    public static IceInternal.DispatchStatus
    ___getCurrentRunningTasks(MonitorService __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
	__checkMode(Ice.OperationMode.Normal, __current.mode);
	IceInternal.BasicStream __os = __inS.os();
	TaskDetail[] __ret = __obj.getCurrentRunningTasks(__current);
	TasksDetailHelper.write(__os, __ret);
	return IceInternal.DispatchStatus.DispatchOK;
    }
	...
	switch(pos)
	{
	    ...
	    case 2:
	    {
		return ___getCurrentRunningTasks(this, in, __current);
	    }
	    case 3:
	    {
