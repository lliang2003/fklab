...
public:
    ...
    ::mapreduce::slice::TasksDetail getCurrentRunningTasks()
    {
	return getCurrentRunningTasks(__defaultContext());
    }
    ::mapreduce::slice::TasksDetail getCurrentRunningTasks(const ::Ice::Context&);
...
public:
    ...
    virtual ::mapreduce::slice::TasksDetail getCurrentRunningTasks(const ::Ice::Context&) = 0;
...
public:
    ...
    virtual ::mapreduce::slice::TasksDetail getCurrentRunningTasks(const ::Ice::Context&);
...
public:
    ...
    virtual ::mapreduce::slice::TasksDetail getCurrentRunningTasks(const ::Ice::Current& = ::Ice::Current()) = 0;
    ::IceInternal::DispatchStatus ___getCurrentRunningTasks(::IceInternal::Incoming&, const ::Ice::Current&);
