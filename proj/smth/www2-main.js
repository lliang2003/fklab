...
function setHots(h) {
	...
	for(i=0; i<h.length; i++) {
		if (h[i]) {
			...
			'[<a href="http://www.newsmth.net/bbstcon.php?board=' + hotBoard + '&gid=' + h[i][0] + '">同主题</a>](' + h[i][2] + ')');
		}
	}
	if (gIE) {
		var str = '';
...
docWriter.prototype.o = function(id, gid, author, flag, time, title, size, imported, is_tex) {
	...
	switch (this.ftype) {
		case dir_modes["ORIGIN"]:
			str += '<a href="http://www.newsmth.net/bbstcon.php?board=' + this.board + '&gid=' + gid + '">' + title + '</a>';
			break;
...
docWriter.prototype.t = function() {
	...
	/* ads starts ZhiDing ads 置底 
					  ["Mobile", "Sep&nbsp;17","/indexpages/ads/hualala/090203huall.gif",914,
					   "奥运门票等你拿，奥运手机等你抢！"],
        */
	var ZhiDingAds = [["AdvancedEdu", "Sep&nbsp;10","/guangg/g/091023qide.htm",848,
					   "09最新《海外奖学金宝典》免费疯狂下载"],
                       ["EnglishTest", "Nov&nbsp;24","/guangg/g/091118xdf.html",964,
					   "新东方寒假班，冬日里的阳光课堂！"],  
                       ["Career_Post", "Dec&nbsp;02","/guangg/g/091208yd.htm",964,
					   "中国移动通信集团北京有限公司2010校园招聘公告"], 
                       ["Career_Plaza", "Dec&nbsp;02","/guangg/g/091202hs.htm",964,
					   "合生创展2010校园招聘全面启动，百余职位只为等你！"],
                       ["Career_Plaza", "Dec&nbsp;02","/guangg/g/091208lx.htm",964,
					   "联想IGP事业部职位热招中"],
                       ["Career_Post", "Dec&nbsp;02","/guangg/g/091126df.htm",964,
					   "中国商用飞机有限责任公司2010校园招聘"],
                       ["Career_Plaza", "Dec&nbsp;02","/guangg/g/091208wk.htm",964,
					   "五矿地产2010校园招聘启动啦！"],
                       ["Career_Plaza", "Dec&nbsp;02","/guangg/g/091208ys.htm",964,
					   "中央电视台2010年度毕业生需求信息"],
                       ["Paper", "Nov&nbsp;14","/guangg/g/091204ss.htm",964,
					   "深度搜--集4万多种中英文权威学术期刊，6千万篇专业学术论文"],
                       ["EnglishWorld", "Nov&nbsp;14","/guangg/g/091114ty.htm",964,
					   "2010年ETS托业奖学金项目（中国大陆地区）"],
                       ["EnglishWorld", "Nov&nbsp;14","/guangg/g/091114tf.htm",964,
					   "托福奖学金项目－留学考托福，赢取奖学金！"],
                       ["Entrepreneur", "Nov&nbsp;18","/guangg/g/091118tp.htm",964,
					   "万份创业计划   飚出青年爱心"],					   
                       ["Mobile", "Nov&nbsp;18","/guangg/g/091207sx.htm",964,
					   "Anycall Dreamers韩国梦想之旅游记"],	
                       ["Oversea", "Nov&nbsp;18","/guangg/g/091207yt.htm",964,
					   "想出国买美国运通旅行支票的童鞋们，咱们的机会来了！"],	
                       ["Beauty", "Nov&nbsp;18","/guangg/g/091207rl.htm",964,
					   "瑞丽09校园十大好感女生出炉！"],	
                       ["Notebook", "Nov&nbsp;18","/guangg/g/091209tp.htm",964,
					   "干掉上网本--B450我的超值选择 (处理器温度凉的吓人)"],	
                       ["SkiWorld", "Nov&nbsp;25","/guangg/g/091207hx.htm",964,
					   "本周六（12.12）怀北滑雪，提供免费初中级教练指导！"],
                       ["TVShow", "Nov&nbsp;18","/guangg/g/091119hp.htm",964,
					   "不比脸蛋比脑袋的亚洲首部电视真人选秀开拍啦"]
					 ];
	if (this.start > this.total - 30) {
		var p;
...
/*
				  ...
				  ['AdvancedEdu','http://www.cedca.cn','090822xuemei.gif',801],
				  ['Mobile','http://count.chanet.com.cn/click.cgi?a=179856&d=107083&u=&e=','091125sa.gif',801],
				  ['Age','http://www.huall.cn','/hualala/091111hll.gif',801]
				];
...
conWriter.prototype.t = function() {
	...
	if (ao) {
		...
		ret += '[<a href="http://www.newsmth.net/bbstcon.php?board=' + this.board + '&gid=' + this.gid + '">同主题展开</a>] ';
		ret += '[<a href="bbscon.php?bid=' + this.bid + '&id=' + this.gid + '">同主题第一篇</a>] ';
		ret += '[<a href="http://www.newsmth.net/bbstcon.php?board=' + this.board + '&gid=' + this.gid + '&start=' + this.id + '">从此处展开</a>] ';
...
tconWriter.prototype.h = function() {
	...
	ret += '[<a href="http://www.newsmth.net/bbstcon.php?board=' + this.board + '&gid=' + this.prevgid + '">上一主题</a>] ';
	ret += '[<a href="http://www.newsmth.net/bbstcon.php?board=' + this.board + '&gid=' + this.nextgid + '">下一主题</a>]';
	ret += '</span>【分页： ';
	var u = 'http://www.newsmth.net/bbstcon.php?board=' + this.board + '&gid=' + this.gid + '&start=' + this.start + '&pno=';
