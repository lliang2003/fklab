...
static const ::std::string __tfs__slice__Transfer__writeAll_name = "writeAll";
...
::Ice::Int
IceProxy::tfs::slice::Transfer::writeAll(::Ice::Long chunkid, const ::tfs::slice::ByteSeq& bytes, ::Ice::Int offset, ::Ice::Int len, const ::tfs::slice::Addresses& addrs, const ::Ice::Context& __ctx)
{
    int __cnt = 0;
    while(true)
    {
	try
	{
	    __checkTwowayOnly(__tfs__slice__Transfer__writeAll_name);
	    ::IceInternal::Handle< ::IceDelegate::Ice::Object> __delBase = __getDelegate();
	    ::IceDelegate::tfs::slice::Transfer* __del = dynamic_cast< ::IceDelegate::tfs::slice::Transfer*>(__delBase.get());
	    return __del->writeAll(chunkid, bytes, offset, len, addrs, __ctx);
	}
	catch(const ::IceInternal::LocalExceptionWrapper& __ex)
	{
	    __handleExceptionWrapper(__ex);
...
::Ice::Int
IceDelegateM::tfs::slice::Transfer::writeAll(::Ice::Long chunkid, const ::tfs::slice::ByteSeq& bytes, ::Ice::Int offset, ::Ice::Int len, const ::tfs::slice::Addresses& addrs, const ::Ice::Context& __context)
{
    ::IceInternal::Outgoing __og(__connection.get(), __reference.get(), __tfs__slice__Transfer__writeAll_name, ::Ice::Normal, __context, __compress);
    try
    {
	::IceInternal::BasicStream* __os = __og.os();
	__os->write(chunkid);
	...
	{
	    ::tfs::slice::__write(__os, &addrs[0], &addrs[0] + addrs.size(), ::tfs::slice::__U__Addresses());
	}
    }
    catch(const ::Ice::LocalException& __ex)
    {
...
::Ice::Int
IceDelegateD::tfs::slice::Transfer::writeAll(::Ice::Long chunkid, const ::tfs::slice::ByteSeq& bytes, ::Ice::Int offset, ::Ice::Int len, const ::tfs::slice::Addresses& addrs, const ::Ice::Context& __context)
{
    ::Ice::Current __current;
    __initCurrent(__current, __tfs__slice__Transfer__writeAll_name, ::Ice::Normal, __context);
    while(true)
    {
	::IceInternal::Direct __direct(__current);
	::tfs::slice::Transfer* __servant = dynamic_cast< ::tfs::slice::Transfer*>(__direct.servant().get());
	...
	try
	{
	    return __servant->writeAll(chunkid, bytes, offset, len, addrs, __current);
	}
	catch(const ::Ice::LocalException& __ex)
	{
	    throw ::IceInternal::LocalExceptionWrapper(__ex, false);
...
::IceInternal::DispatchStatus
tfs::slice::Transfer::___writeAll(::IceInternal::Incoming&__inS, const ::Ice::Current& __current)
{
    __checkMode(::Ice::Normal, __current.mode);
    ::IceInternal::BasicStream* __is = __inS.is();
    ::IceInternal::BasicStream* __os = __inS.os();
    ...
    __is->read(offset);
    __is->read(len);
    ::tfs::slice::__read(__is, addrs, ::tfs::slice::__U__Addresses());
    try
    {
	::Ice::Int __ret = writeAll(chunkid, bytes, offset, len, addrs, __current);
	__os->write(__ret);
    }
    catch(const ::tfs::slice::ChunkError& __ex)
    {
...
{
    ::std::pair< ::std::string*, ::std::string*> r = ::std::equal_range(__tfs__slice__Transfer_all, __tfs__slice__Transfer_all + 11, current.operation);
    if(r.first == r.second)
    {
