...
#define _CATCH_
//#define _TRY_ try 
//#define _CATCH_ catch (TFSException &ex) {TS_FAIL(ex.what());}

class TestFileSystem : public CxxTest::TestSuite {
public:
    void testSimpleDirectory() _TRY_ {
        tfs::Client::init(true);
        FileSystem tfs;
    ...
    void testDirectoryException() _TRY_ {
