...
public:
    ...
    ::Ice::Int writeAll(::Ice::Long chunkid, const ::tfs::slice::ByteSeq& bytes, ::Ice::Int offset, ::Ice::Int len, const ::tfs::slice::Addresses& addrs)
    {
	return writeAll(chunkid, bytes, offset, len, addrs, __defaultContext());
    }
    ::Ice::Int writeAll(::Ice::Long, const ::tfs::slice::ByteSeq&, ::Ice::Int, ::Ice::Int, const ::tfs::slice::Addresses&, const ::Ice::Context&);
...
public:
    ...
    virtual ::Ice::Int writeAll(::Ice::Long, const ::tfs::slice::ByteSeq&, ::Ice::Int, ::Ice::Int, const ::tfs::slice::Addresses&, const ::Ice::Context&) = 0;
...
public:
    ...
    virtual ::Ice::Int writeAll(::Ice::Long, const ::tfs::slice::ByteSeq&, ::Ice::Int, ::Ice::Int, const ::tfs::slice::Addresses&, const ::Ice::Context&);
...
public:
    ...
    virtual ::Ice::Int writeAll(::Ice::Long, const ::tfs::slice::ByteSeq&, ::Ice::Int, ::Ice::Int, const ::tfs::slice::Addresses&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::IceInternal::DispatchStatus ___writeAll(::IceInternal::Incoming&, const ::Ice::Current&);
